  ...
  theme: {
    extend: {
      colors: {
        ...
        secondary: 'var(--color-secondary, #2661b0)',
        tertiary: '#2a0002',
        'surface-page': '#F8F9FA',
        ...
        'navy-deep': 'var(--color-navy-deep, #0b1c32)',
        ...
        'accent-red-hover': 'var(--color-accent-red-hover, #eb7578)',
        'on-secondary-fixed': '#001944',
        'surface-container-lowest': '#ffffff',
        'surface-container-high': '#dce9ff',
        'surface-card': '#FFFFFF',
        'surface-variant': '#d2e4ff',
        primary: 'var(--color-primary, #14335C)',
        'primary-container': 'var(--color-primary-container, #14335C)',
